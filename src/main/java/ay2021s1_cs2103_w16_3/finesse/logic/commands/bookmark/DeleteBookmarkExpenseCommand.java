...
public class DeleteBookmarkExpenseCommand extends Command {
    ...
    public static final String MESSAGE_DELETE_FREQUENT_EXPENSE_SUCCESS = "Deleted Bookmark Expense: %1$s";
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        return new CommandResult(String.format(MESSAGE_DELETE_FREQUENT_EXPENSE_SUCCESS, bookmarkExpenseToDelete));
    }
